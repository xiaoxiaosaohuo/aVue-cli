...
const { semver, matchesPluginId } = require('../share-utils')
...
class PluginAPI {
  ...
  assertVersion (range) {
    ...
    throw new Error(
      `Require aVue-cli-service "${range}", but was loaded with "${this.version}".`
    )
  }
  ...
  genCacheConfig (id, partialIdentifier, configFiles = []) {
    ...
    const variables = {
      partialIdentifier,
      'aVue-cli-service': require('../package.json').version,
