...
const { chalk, warn, error, isPlugin, resolvePluginId, loadModule, resolvePkg } = require('../share-utils')
...
module.exports = class Service {
  ...
  resolvePlugins (inlinePlugins, useBuiltIn) {
    const idToPlugin = (id,isProject) => ({
      id: id.replace(/^.\//, 'built-in:'),
      apply: isProject === true ? require(path.resolve(this.context,id)) :require(id)
    })
