const defaults = {
    ...
    api.registerCommand('build', {
      ...
      if (args.modern && args.target === 'app') {
        ...
        if (!process.env.VUE_CLI_MODERN_BUILD) {
          ...
          const { execa } = require('../../../share-utils')
          const cliBin = require('path').resolve(__dirname, '../../../bin/aVue-cli-service.js')
        ...
        if (args.modern) {
          const { warn } = require('../../../share-utils')
          warn(
  ...
  async function build (args, api, options) {
    ...
    const { chalk } = require('../../../share-utils')
